                  ...
                  <div class="col-md-6 border-right border-bottom">
                    <div class="detail">
                      ...
                      <ul class="list-unstyled">
                        <li>
                          <i class="icon icon-phone"></i>+ 91 9106005682
                        </li>
                        <li>
                          <i class="icon icon-phone"></i>+ 91 7405469759
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div class="detail">
                      ...
                      <ul class="list-unstyled">
                        <li>
                          ...
                          <a href="mailto:info@yourcompany.com">info@ultras.com</a>
                        </li>
                        <li>
                          <i class="icon icon-envelope"></i>
                          <a href="mailto:info@yourcompany.com">info@ultras.com</a>
                    ...
                    <div class="address detail">
                      ...
                      <ul class="list-unstyled">
                        <li>
                          ...
                          <span>Rajkot,Gujarat 380015, India</span>
                        </li>
                      </ul>
                    </div>
                  </div>
